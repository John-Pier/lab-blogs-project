...
export const BP_APP_API_CONFIG: InjectionToken<BPAppAPIConfig> = new InjectionToken<BPAppAPIConfig>('BP_APP_API_CONFIG');
export const BP_CONTACTS_DATA_CONFIG: InjectionToken<BPContactsDataConfig> = new InjectionToken<BPContactsDataConfig>('BP_CONTACTS_DATA_CONFIG');
